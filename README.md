...
To replicate data analysis, go to the folder `Real data`. Each R script corresponds to the main code for the analysis in Section 5 of the manuscript. Guidelines for downloading the data are provided as comments in the R scripts.
